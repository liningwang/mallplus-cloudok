...
public class SmsHomeAdvertiseController {
    @Resource
    private com.mallplus.marking.service.ISmsHomeAdvertiseService ISmsHomeAdvertiseService;
    ...
    public Object getSmsHomeAdvertiseByPage(SmsHomeAdvertise entity,
        ...
        try {
            return new CommonResult().success(ISmsHomeAdvertiseService.page(new Page<SmsHomeAdvertise>(pageNum, pageSize), new QueryWrapper<>(entity).orderByDesc("start_time")));
        } catch (Exception e) {
