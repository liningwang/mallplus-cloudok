...
export default {
	...
	order: {
		...
		updateQuantity: 'api-order/auth/update/quantity', //修改购物车中某个商品的数量
	...
	marking: {
		...
		acceptCoupon: 'api-marking/auth/acceptCoupon', // 获取优惠券
		listMemberCoupon: 'api-marking/auth/listMemberCoupon', // 优惠券列表
		couponList: 'api-marking/notAuth/coupon/list', //  可领取的优惠券
